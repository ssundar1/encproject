...
INSERT INTO BLC_CURRENCY(CURRENCY_CODE, FRIENDLY_NAME, DEFAULT_FLAG) VALUES('INR', 'Indian Rupees', false);

INSERT INTO `broadleaf`.`blc_country` (`ABBREVIATION`, `NAME`) VALUES ('IN', 'India');
