...
public interface ServiceProviderService {
    ...
    public ServiceProvider saveServiceProvider(ServiceProvider serviceProvider, boolean register);

    public ServiceProvider registerServiceProvider(ServiceProvider serviceProvider, String password, String passwordConfirm);

    public ServiceProvider readServiceProviderByUsername(String serviceProviderName);
     ...
     * @param serviceProviderId the id of the ServiceProvider to lookup
     * @return either a <code>ServiceProvider</code> from the database if it exists, or a new non-persisted <code>ServiceProvider</code>
     */
    public ServiceProvider createServiceProviderFromId(Long serviceProviderId);
    
    /**
     * Returns a non-persisted <code>ServiceProvider</code>.    Typically used with registering a new service provider.
     */
    ...
    /**
     * Looks up the corresponding Service Provider and emails the address on file with
